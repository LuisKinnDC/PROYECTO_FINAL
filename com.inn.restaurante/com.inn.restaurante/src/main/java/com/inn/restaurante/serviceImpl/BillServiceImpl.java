...
import com.inn.restaurante.dao.BillDao;
...
public class BillServiceImpl implements BillService {
    ...
    private void insertBill(Map<String, Object> requestMap) {
        try {
            ...
            bill.setCreatedBy(jwtFiler.getCurrentUser());
            billDao.save(bill);
        }catch (Exception ex){
            ex.printStackTrace();
        }
    ...
    public ResponseEntity<List<Bill>> getBills() {
        ...
        if (jwtFiler.isAdmin()){
            ...
            list = billDao.getBillByUserName(jwtFiler.getCurrentUser());
        }
    ...
    public ResponseEntity<byte[]> getPdf(Map<String, Object> requestMap) {
        ...
        try {
            ...
            String filePath = RestaurantConstents.STORE_LOCATION+"\\"+(String) requestMap.get("uuid") + ".pdf";
